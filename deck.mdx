...
## Diagram!
![React Inverse Data Flow Diagram](https://res.cloudinary.com/dnocv6uwb/image/upload/v1645814361/react-inverse-data-flow-diagram_zpunjn.png)
...
Implement Inverse Data flow to fix a broken search feature. [Open Codesandbox](https://codesandbox.io/s/inverse-data-flow-exercise-otvjp?file=/src/App.js) - instructions in `src/App.js`
